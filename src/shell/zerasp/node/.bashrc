...
#	Jun 20 2021		Deploy in cams21 environment
#                   This file is copied in the login directory of node account after deployment
#----------------------------------------------------------------------------------------
...
# User env 
echo
echo 'Welcome, .bashrc 1.12: Jun 20 2021'
echo
